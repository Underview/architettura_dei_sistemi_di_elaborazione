...
cycle:
    ...
    l.d f5,v1(r2); carico v1
    l.d f4,v4(r2)
    add.d f5,f5,f3;sommo v1 e v2*v3
    s.d f5,v5(r2);contiene f5
    mul.d f6,f5,f4
    s.d f6,v6(r2)
    div.d f7,f6,f1
    s.d f7,v7(r2)
    ...
    l.d f12,v1(r3); carico v1
    l.d f11,v4(r3)
    add.d f12,f12,f10;sommo v1 e v2*v3
    s.d f12,v5(r3);contiene f12
    mul.d f13,f12,f11
    ...
    add.d f19,f19,f17;sommo v1 e v2*v3
    s.d f19,v5(r2);contiene f19
    mul.d f20,f19,f18
    ...
    l.d f26,v1(r5); carico v1
    l.d f25,v4(r5)
    s.d f20,v6(r4)
    div.d f21,f20,f15
     add.d f26,f26,f24;sommo v1 e v2*v3
    s.d f21,v7(r4)


   
    s.d f26,v5(r5);contiene f26
    mul.d f27,f26,f25
    s.d f27,v6(r5)
    div.d f28,f27,f22
    s.d f28,v7(r5)
